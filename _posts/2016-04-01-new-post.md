...
spent part of a recent Friday going through the [React Tutorial][react-tutorial]
as a team. Since we're all [Ember][ember] developers, many comparisons were
made.
...
contrast the way that both frameworks use components.
...
Let's take a look at our component hierarchy:
